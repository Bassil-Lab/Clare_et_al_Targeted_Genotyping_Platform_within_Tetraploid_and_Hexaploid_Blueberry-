...
configfile: "/nfs3/HORT/Bassil_Lab/mandie/Blueberry_VacCap_Project/scripts/snakemake-Final_Table_shared.yaml"

rule all:
    input:
        expand("/nfs3/HORT/Bassil_Lab/mandie/Blueberry_VacCap_Project/VCF_files/VacCAP/Table1_files_{chroms}.txt", chroms=config["chroms"])
...
rule RunFinalTableShared:
    input:
        ...
        collabfile = "/nfs3/HORT/Bassil_Lab/mandie/Blueberry_VacCap_Project/VCF_files/VacCAP/All_collaborator_Transcript_SNP_POS.txt"
    output:
        table1 = "/nfs3/HORT/Bassil_Lab/mandie/Blueberry_VacCap_Project/VCF_files/VacCAP/Table1_files_{chroms}.txt"
    params:
        chroms = config["chroms"]
    threads:1
    shell:
         """
          /nfs3/HORT/Bassil_Lab/mandie/Blueberry_VacCap_Project/scripts/Final_Table_shared.py -hc {input.hardcore} -sc {input.softcore} -g {input.gfffile} -f {input.singlefile} -c {input.collabfile} -o {output.table1}
         """
